...
class LightColor extends AppColor {
  ...
  @override
  Color get primaryColor => const Color(0xff79b9e5);
...
class DarkColor extends AppColor {
  ...
  @override
  Color get primaryColor => const Color(0xff26272c);
...
class AppTheme {
  ...
  static Color primaryColor = const Color(0xff79b9e5);
  static ThemeData lightTheme() {
    ...
    return ThemeData(
      ...
      drawerTheme: DrawerThemeData(backgroundColor: appColor.backgroundColor),
      textTheme: TextTheme(
